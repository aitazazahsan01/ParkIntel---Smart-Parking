...
import { Building2, Loader2, ArrowLeft, Mail, Lock, User, Eye, EyeOff } from "lucide-react";
...
export default function OwnerSignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        console.log('✅ Stored pendingUserRole as OWNER');
        console.log('🔍 Verify localStorage:', verifyLocal);
        console.log('🔍 Verify sessionStorage:', verifySession);
        console.log('🔍 Values match:', verifyLocal === 'owner' && verifySession === 'owner');
      }
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.session) {
        // Logged in immediately, redirect to owner dashboard
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-linear-to-br from-purple-50 via-white to-pink-50 dark:from-slate-950 dark:via-slate-900 dark:to-purple-950" />
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center p-4 py-12">
        ...
        <div className="mb-12 text-center max-w-2xl">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-linear-to-br from-purple-600 to-pink-600 shadow-2xl mb-8">
              ...
              <>
                ...
                <div className="space-y-3">
                  <Button 
                    ...
                    disabled={loading}
                    className="w-full bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white h-14 text-base font-semibold shadow-lg hover:shadow-xl transition-all"
                  >
                    {loading ? (
                      <>
                  ...
                  <Button 
                    ...
                    variant="outline"
                    className="w-full h-14 text-base font-semibold border-2 border-purple-200 dark:border-purple-800 hover:bg-purple-50 dark:hover:bg-purple-950/30"
                  >
              ...
              <>
                ...
                <form onSubmit={handleEmailSignUp} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-700 rounded-xl focus:border-purple-500 dark:focus:border-purple-500 focus:ring-0 text-slate-900 dark:text-white placeholder-slate-400"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-12 py-3 bg-white dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-700 rounded-xl focus:border-purple-500 dark:focus:border-purple-500 focus:ring-0 text-slate-900 dark:text-white placeholder-slate-400"
                        placeholder="••••••••"
                        required
                      />
                      <button
                  ...
                  <Button 
                    type="submit"
                    disabled={loading}
                    className="w-full bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white h-12 text-base font-semibold shadow-lg hover:shadow-xl transition-all"
                  >
                    {loading ? (
                      <>
                        <Loader2 className="animate-spin mr-2" size={20} />
